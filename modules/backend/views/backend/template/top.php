...
<head>
    ...
    <!-- daterange picker -->
    <link rel="stylesheet" href="<?php echo URL::base(TRUE); ?>static/AdminLTE/plugins/daterangepicker/daterangepicker.css">
    <!-- bootstrap datepicker -->
    <link rel="stylesheet" href="<?php echo URL::base(TRUE); ?>static/AdminLTE/plugins/datepicker/datepicker3.css">
    <!-- iCheck for checkboxes and radio inputs -->
    <link rel="stylesheet" href="<?php echo URL::base(TRUE); ?>static/AdminLTE/plugins/iCheck/all.css">
    <!-- Bootstrap Color Picker -->
    <link rel="stylesheet" href="<?php echo URL::base(TRUE); ?>static/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css">
    <!-- Bootstrap time Picker -->
    <link rel="stylesheet" href="<?php echo URL::base(TRUE); ?>static/AdminLTE/plugins/timepicker/bootstrap-timepicker.min.css">
    <!-- Select2 -->
    <link rel="stylesheet" href="<?php echo URL::base(TRUE); ?>static/AdminLTE/plugins/select2/select2.min.css">
    <!-- jvectormap -->
