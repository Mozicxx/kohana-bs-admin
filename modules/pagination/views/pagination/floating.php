...
<p class="pagination">
    ...
    <?php if ($previous_page !== FALSE): ?>
        <a  class="prev" href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Previous') ?></a>
    <?php else: ?>
    ...
    <?php foreach ($links as $number => $content): ?>
        ...
        <?php if ($number === $current_page): ?>
            <a class="current"><i><strong><?php echo $content ?></strong></i></a>
        <?php else: ?>
            <a href="<?php echo HTML::chars($page->url($number)) ?>"><i><?php echo $content ?></i></a>
        <?php endif ?>
