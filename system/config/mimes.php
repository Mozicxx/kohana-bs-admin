...
/**
 * A list of mime types. Our list is generally more complete and accurate thanmime类型的列表。我们的列表是通常更完整、准确
 * the operating system MIME list.MIME列表的操作系统
 *
 * If there are any missing options, please create a ticket on our issue tracker,如果有任何遗漏的选项,请创建一个票问题跟踪器
 * http://kohanaphp.com/trac/newticket. Be sure to give the filename andhttp://kohanaphp.com/trac/newticket。一定要给出文件名和
 * expected MIME type, as well as any additional information you can provide.预期的MIME类型,以及任何额外的信息可以提供
 */
return array(
	'323'      => array('text/h323'),
